...
export default function BillingPage() {
  ...
  const plans: BillingPlanModel[] = PLANS;
                ...
                <div className="flex items-center gap-4 text-xs text-slate-400">
                  <span className="flex items-center gap-1.5">
                    ...
                    <span className="text-white font-semibold ml-0.5">
                      {state.expiresAt ? formatDate(state.expiresAt) : "--"}
                    </span>
                  </span>
            ...
            >
              ...
              <div className="px-5 py-4 space-y-3">
                {[
                  ...
                  {
                    n: 2,
                    title: `Send exactly ${selectedPlanData.priceTao} TAO`,
              ...
              <div className="px-5 pb-5">
                ...
                >
                  ...
                  Generate Payment Address for {selectedPlanData.priceTao} TAO
      ...
      <FadeIn delay={0.16}>
        ...
        >
          ...
          >
            ...
            >
              {["Date", "Plan", "TAO Amount", "USD", "Type", "Tx Hash", "Status"].map((h) => (
